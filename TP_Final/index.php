...
<body>
        <div id="container1" class="container">
            ...
            <div class="col-md-3 text-end">
                <a class="btn btn-outline-primary me-2" href="http://localhost/php_codoacodo/TP_Final/autentication.php">Login</a>
                <a class="btn btn-primary" href="http://localhost/php_codoacodo/TP_Final/register_view.php">Registrate</a>
            </div>
        </div>     
</header>
    <main>
