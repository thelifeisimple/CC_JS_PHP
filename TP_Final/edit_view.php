...
<body>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            <h3>DD Edición</h3>
            <p class="blue-text">Edita tu usuario</p>
            <div class="card">
                <h5 class="text-center mb-4">Datos</h5>
                <form class="form-card" action="update_user.php" method="POST" >             

                <!-- traer datos de sesion y ponerlos en el placeholder -->
                    ...
                    <div class="row justify-content-end">
                        <div class="form-group col-sm-6"> <input type="submit" class="btn-block btn-primary" value="Modificar"> </div>
                    </div>
                </form>
            </div>
        </div>
